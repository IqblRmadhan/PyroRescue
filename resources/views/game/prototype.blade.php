        ...
        <main class="game-layout">
            ...
            <aside class="game-panel wood-frame">
                ...
                <div class="panel-content">
                    ...
                    <button id="hint" class="hint-button" type="button">Butuh petunjuk? <strong>Hint</strong></button>
                    <p id="hint-text" aria-live="polite"></p>
                    <div id="feedback" role="status" aria-live="polite">Memuat area game...</div>
                    <p class="run-note">Run melanjutkan dari posisi terakhir. Reset mengembalikan karakter ke titik awal dan mengosongkan kode.</p>
                </div>
            </aside>
        </main>
